	...
	public void testCoordinatesToken()
	{
		...
		try {
			...
			result = checkFail(target(getCoordinatesToken)
					.request().header(Header.Accept.toString(), MediaType.APPLICATION_XML).get())
					.readEntity(String.class);
			retrievedToken = RestTestUtils.unmarshalObject(RestCoordinatesToken.class, result);
			...
			result = checkFail(target(getTaxonomyCoordinate)
					.request().header(Header.Accept.toString(), MediaType.APPLICATION_XML).get())
					.readEntity(String.class);
			RestTaxonomyCoordinate retrievedTaxonomyCoordinate = RestTestUtils.unmarshalObject(RestTaxonomyCoordinate.class, result);
			...
			result = checkFail(target(getTaxonomyCoordinate)
					...
					.request().header(Header.Accept.toString(), MediaType.APPLICATION_XML).get())
					.readEntity(String.class);
			retrievedTaxonomyCoordinate = RestTestUtils.unmarshalObject(RestTaxonomyCoordinate.class, result);
