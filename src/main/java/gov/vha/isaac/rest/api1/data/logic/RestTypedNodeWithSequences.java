...
/**
 * 
 * {@link RestTypedNodeWithSequences}
 *
 * @author <a href="mailto:joel.kniaz.list@gmail.com">Joel Kniaz</a>
 *
 */
@XmlRootElement
public abstract class RestTypedNodeWithSequences extends RestConnectorNode {
	@XmlElement
	int typeConceptSequence;
	
	protected RestTypedNodeWithSequences() {
		// For JAXB
	}
	/**
	 * @param connectorNode
	 */
	public RestTypedNodeWithSequences(TypedNodeWithSequences typedNodeWithSequences) {
		super(typedNodeWithSequences);
		typeConceptSequence = typedNodeWithSequences.getTypeConceptSequence();
	}
