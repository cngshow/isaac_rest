...
/**
 * 
 * {@link RestRoleNodeAllWithSequences}
 *
 * @author <a href="mailto:joel.kniaz.list@gmail.com">Joel Kniaz</a>
 *
 */
@XmlRootElement
public class RestRoleNodeAllWithSequences extends RestTypedNodeWithSequences {
	protected RestRoleNodeAllWithSequences() {
		// For JAXB
	}
	/**
	 * @param roleNodeAllWithSequences
	 */
	public RestRoleNodeAllWithSequences(RoleNodeAllWithSequences roleNodeAllWithSequences) {
