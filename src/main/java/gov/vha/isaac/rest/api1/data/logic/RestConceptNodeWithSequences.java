...
/**
 * 
 * {@link RestConceptNodeWithSequences}
 *
 * @author <a href="mailto:joel.kniaz.list@gmail.com">Joel Kniaz</a>
 *
 */
@XmlRootElement
public class RestConceptNodeWithSequences extends RestLogicNode {

	@XmlElement
	int conceptSequence;
	
	protected RestConceptNodeWithSequences() {
		// For JAXB
	}
	/**
	 * @param conceptNodeWithSequences
	 */
	public RestConceptNodeWithSequences(ConceptNodeWithSequences conceptNodeWithSequences) {
    ...
    public String toString(String nodeIdSuffix) {
        return "Concept[" + nodeIndex + nodeIdSuffix + "] " + Get.conceptDescriptionText(conceptSequence) + " <"
