...
@XmlType(propOrder = { "vuid", "versionName", "preferredDesignationName", "textualDefinition", "description",
		"effectiveDate", "status", "mapEntries", "sourceValueType", "sourceCodeSystemVuid",
		"sourceCodeSystemPreferredDesignation", "sourceCodeSystemVersionName", "targetValueType",
		"targetCodeSystemVuid", "targetCodeSystemPreferredDesignation", "targetCodeSystemVersionName" })
