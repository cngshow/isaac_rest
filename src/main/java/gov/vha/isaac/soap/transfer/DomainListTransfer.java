...
@XmlType(propOrder = { "totalNumberOfRecords", "domainTransfers" })
public class DomainListTransfer {
	private Long totalNumberOfRecords;
	private List<DomainTransfer> domainTransfers = new ArrayList<DomainTransfer>();
	...
	@XmlElement(name = "DomainList", required = false, nillable = true)
